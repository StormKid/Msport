...
package com.msport.clientmaster.view.wheelview.views;
...
import com.msport.clientmaster.view.wheelview.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private static final int[] SHADOWS_COLORS = new int[] { 0xeeffffff, 0xeaffffff, 0x88ffffff };
