...
//			LogUtils.e(TAG, "httpGet, url is null");
//			return null;
//		}
//
...
//				LogUtils.e(TAG, "httpGet fail, status code = " + resp.getStatusLine().getStatusCode());
//				return null;
//			}
//
...
//		if (url == null || url.length() == 0) {
//			LogUtils.e(TAG, "httpPost, url is null");
//			return null;
//		}
//
//		HttpClient httpClient = getNewHttpClient();
...
//				return null;
//			}
//			LogUtils.e(TAG, resp.getEntity().toString());
//			return EntityUtils.toByteArray(resp.getEntity());
//		} catch (Exception e) {
//			LogUtils.e(TAG, "httpPost exception, e = " + e.getMessage());
//			e.printStackTrace();
//			return null;
//		}
//	}
